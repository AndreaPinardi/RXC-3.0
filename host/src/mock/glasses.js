...
window.config = {
    ...
    products: [
      {
        ...
        category: "EYE",
        thumbnailUrl:
          "https://assets.lenscrafters.com/is/image/LensCrafters/8056597940177__001.png?imwidth=200&defaultimage=8056597940177__002?differentUrl=true",
        brand: {
          name: "Giorgio Armani",
          logoUrl:
            "https://assets.lenscrafters.com/extra/image/LensCrafters/brands/LC_Giorgio_Armani_Logo.png?differentUrl=true",
        },
  ...
  actionsModule: {
    genericAddToCart: function (
      ...
      console.log("genericAddToCart called");
    },
    genericSaveEditFromCart: function (
      ...
      console.log("genericSaveEditFromCart called");
    },
    ...
    loadLearnMoreContent: function (_loadMoreContentName) {
      ...
      return new Promise(function (resolve, reject) {
        resolve(
          '<div className="LearnMoreModal__container">\n  <div className="LearnMoreModal__container__title">\n    <h1>Worry-free</h1>\n    <h1>eyewear protection plan</h1>\n  </div>\n  <div className="LearnMoreModal__container__description">\n    <p>Keep your pair as good as new! Get one year of protection plan coverage for your glasses in case you need a replacement, starting at $24.99 (+co-pay when applicable)</p>\n  </div>\n\n  <ul className="LearnMoreModal__container__list">\n    <li className="LearnMoreModal__container__list__item">Cracked or scratched lenses</li>\n    <li className="LearnMoreModal__container__list__item">Cracked frames</li>\n    <li className="LearnMoreModal__container__list__item">Normal wear and tear</li>\n    <li className="LearnMoreModal__container__list__item">Defects in materials and workmanship</li>\n    <li className="LearnMoreModal__container__list__item">See <a href="/gl-us/terms-and-conditions">Terms and Conditions</a> for full plan details</li>\n  </ul>\n</div>'
        );
      });
    },
  ...
  data: {
    ...
    frame: {
      ...
      brand: "Ray-Ban",
      imageUrl:
        "https://assets.glasses.com/is/image/Glasses/8053672503371__002.png?impolicy=GL_parameters_transp&width=860",
      brandImageUrl: "",
      category: "EYEGLASSES",
      rxValues: {
  ...
  prescriptionModule: {
    ...
    prescriptionFlows: ["MANUAL", "ACCOUNT"], //'MANUAL','ACCOUNT','UPLOAD','CMD'
    fileExtensions: [
      "png",
      "gif",
      "jpeg",
